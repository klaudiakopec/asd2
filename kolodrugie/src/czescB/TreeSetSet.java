...
public class TreeSetSet {
    ...
    public void insert(int elem)    // wstawia element do zbioru Integer na 4
    {
        if (!member(elem)) // sprawdza, czy dany element nalezy do zbioru
            treeSet.add(new Integer(elem));
    }

    public boolean member(int elem)  // sprawdza, czy dany element nalezy do zbioru   Integer na 4
    {
